...
//Récupération des monstres de ma base "mymonsters"
$monsters = getMonsters_PDO();
?>
...
<html lang="fr">
    ...
    <body>
        ...
        <!-- Création d'un formulaire pour récupérer les informations du monstre
        grâce à des textFields, la méthode de récupération sera POST et la validation du formulaire
        entrainera l'exécution de add.php -->
        <form method="POST" action="add.php">
            ...
            <br>
        <button class="btn btn-md btn-danger center-block" type="submit" name = "add">ADD MONSTER</button>
        </form>
        ...
        <form method="POST" action="delete.php">
            Name:<br>
            <input type="text" name="name"><br>
            <button class="btn btn-md btn-danger center-block" type="submit" name = "delete">DELETE MONSTER</button>
        </form>
